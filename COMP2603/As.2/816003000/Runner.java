...
public class Runner {
    ...
    public static void main(String[] args){
       ...
       Vehicle v1 = new HotAirBalloon("HB100", 40);
       ...
       RentalRecord r = new RentalRecord(LocalDate.now(), LocalDate.of(2018,03,10), v1, c1);
       r.validate();            // validate the request
       System.out.println(r);   // print out the request details after validation
              
       RentalRecord r2 = new RentalRecord(LocalDate.now(), LocalDate.of(2018,03,10), v1, c2);
       r2.validate();
       System.out.println(r2);
       
       RentalRecord r3 = new RentalRecord(LocalDate.now(), LocalDate.of(2018,03,10), v2, c3);
       r3.validate();
       System.out.println(r3);
       
       RentalRecord r4 = new RentalRecord(LocalDate.now(), LocalDate.of(2018,03,10), v3, c4);
       r4.validate();
       System.out.println(r4);
       
       RentalRecord r5 = new RentalRecord(LocalDate.now(), LocalDate.of(2018,03,10), v3, c5);
       r5.validate();
